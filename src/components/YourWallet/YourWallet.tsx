            ...
            <TabContext value={selectedTokenIndex.toString()}>
                <TabList onChange={handleChange} aria-label="stake form tabs">
                    {supportedCandidates.map((candidate,index)=>{
                        return(<Tab label={candidate.name}
                ...
                {supportedCandidates.map((candidate,index)=>{
                    return(
                        ...
                        <div>
                            <WalletBalance candidate={supportedCandidates[selectedTokenIndex]}/>
                           <VoteStorage candidate ={supportedCandidates[selectedTokenIndex]}/>
                        </div>
                    </TabPanel>
                    )})
                } 
